  ...
  return (
        ...
        <aside id="sidebar">
            ...
            <div className="sidebar-footer">
                <ul className="social unlist">
                <li>
                        <a href="https://github.com/PadharaHitesh" aria-label="Github" target='_blank'>
                    ...
                    <li>
                        <a href="https://twitter.com/PadharaHitesh" aria-label="X" target='_blank'>
                            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/hitesh-padhara" aria-label="Linkedin" target='_blank'>
                            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" >
